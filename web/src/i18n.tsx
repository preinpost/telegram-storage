...
const messages: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'browser.togglePerms': '권한 패널 표시/숨기기',
    ...
    'perm.selectUser': '사용자 선택…',
    'perm.selectUserPrompt': '사용자를 선택하세요',
    'users.title': '사용자 관리',
    'users.openTitle': '사용자 관리 열기',
    'users.username': '사용자명',
    ...
    'users.loadFailed': '사용자 목록을 불러오지 못했습니다',
    'users.copyId': 'ID 복사',
    'users.copied': '{name}의 ID를 복사했습니다',
    'users.roleUpdated': '{name} → {role}',
    'users.roleUpdateFailed': '역할 변경 실패',
    'users.unknown': '알 수 없는 사용자',
    'settings.title': '설정',
    'settings.openTitle': '설정 열기',
    'settings.language': '언어',
    'search.placeholder': '파일 검색…',
    'search.results': '검색 결과 {count}건',
    'search.noResults': '검색 결과가 없습니다',
    'search.failed': '검색에 실패했습니다',
    'search.clear': '검색 지우기',
    'file.move': '이동',
    'move.title': '파일 이동',
    'move.choose': '이동할 폴더 선택',
    'move.confirm': '이동',
    'move.done': '"{name}" 파일을 이동했습니다',
    'move.failed': '파일 이동 실패',
    'upload.dropHint': '여기에 파일을 끌어다 놓으세요',
    'upload.queued': '대기 중',
    'upload.cancelTitle': '업로드 취소',
    'settings.storage': '저장소',
    'settings.totalSize': '총 사용량',
    'settings.fileCount': '파일',
    'settings.folderCount': '폴더',
    'settings.userCount': '사용자',
    'settings.byFolder': '폴더별 사용량',
  },
  en: {
    ...
    'browser.togglePerms': 'Toggle permissions panel',
    'browser.resizeSidebar': 'Resize sidebar',
    ...
    'file.accepted': '“{name}” accepted — processing in the background',
    'file.transferring': 'Processing…',
    'file.transferFailed': 'Processing failed',
    ...
    'perm.selectUser': 'Select user…',
    'perm.selectUserPrompt': 'Select a user',
    'users.title': 'User management',
    'users.openTitle': 'Open user management',
    ...
    'users.copyId': 'Copy ID',
    'users.copied': 'Copied {name}\'s ID',
    'users.roleUpdated': '{name} → {role}',
  ...
  ja: {
    ...
    'browser.togglePerms': '権限パネルの表示/非表示',
    'browser.resizeSidebar': 'サイドバーの幅を調整',
    'folder.title': 'フォルダ',
    'folder.new': '+ 新しいフォルダ',
    ...
    'file.accepted': '「{name}」を受付 — バックグラウンドで処理中',
    'file.transferring': '処理中…',
    'file.transferFailed': '処理失敗',
    ...
    'perm.selectUser': 'ユーザーを選択…',
    'perm.selectUserPrompt': 'ユーザーを選択してください',
    'users.title': 'ユーザー管理',
    'users.openTitle': 'ユーザー管理を開く',
    ...
    'users.loadFailed': 'ユーザー一覧を読み込めませんでした',
    'users.copyId': 'IDをコピー',
    'users.copied': '「{name}」のIDをコピーしました',
    'users.roleUpdated': '{name} → {role}',
    'users.roleUpdateFailed': '役割の変更に失敗しました',
    'users.unknown': '不明なユーザー',
    'settings.title': '設定',
    ...
    'file.move': '移動',
    'move.title': 'ファイルを移動',
    'move.choose': '移動先フォルダを選択',
    'move.confirm': '移動',
    'move.done': '「{name}」を移動しました',
    'move.failed': 'ファイルの移動に失敗しました',
    'upload.dropHint': 'ここにファイルをドロップしてアップロード',
    'upload.queued': '待機中',
    'upload.cancelTitle': 'アップロードをキャンセル',
    'settings.storage': 'ストレージ',
    'settings.totalSize': '合計使用量',
    'settings.fileCount': 'ファイル',
    'settings.folderCount': 'フォルダ',
    'settings.userCount': 'ユーザー',
    'settings.byFolder': 'フォルダ別使用量',
  },
};
